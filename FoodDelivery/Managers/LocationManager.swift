...
final class LocationManager: NSObject {
    ...
    @objc private func sendPlacemark() {
        guard let _ = lastLocation else {
            ...
            didCompleteGeocoding(location: nil, placemark: nil, error: NSError(
        ...
        reverseGeoCoding(location: lastLocation)
        reverseGeoCodingWithPreferredLocale(location: lastLocation)
        lastLocation = nil
    }
    ...
    func getReverseGeoCodedLocationWithPreferredLocale(location:CLLocation,completionHandler:@escaping ReverseGeoLocationClosure) {
        
        self.geoLocationCompletionHandler = nil
        self.geoLocationCompletionHandler = completionHandler
        if !reverseGeocoding {
            reverseGeocoding = true
            self.reverseGeoCodingWithPreferredLocale(location: location)
        }
    ...
    //MARK:- Reverse GeoCoding for State
    private func reverseGeoCodingWithPreferredLocale(location:CLLocation?) {
...
extension LocationManager: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
        debugPrint("Location Status >>>>" , status.rawValue)
        switch status {
